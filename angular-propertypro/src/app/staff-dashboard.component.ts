      ...
      @if (activeTab === 'tasks') {
        <section class="card mb-6">
          ...
          <div class="card-body">
            ...
            @if (lastShift()) {
              <div class="shift-summary mt-6 p-4 rounded-lg border" [class.border-red-300]="!lastShift()!.isValid" [class.border-green-300]="lastShift()!.isValid">
